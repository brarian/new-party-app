...
<img src={brunch} alt="people cheer'sing with drinks"/>
	...
	<div className="grid-x">
		<div className="cell medium-auto landingBox"><img src={pencil} alt="icon of a pencil" className="sym"/><p><span className="head">Plan</span> </p> Choose what type of party you’d like to have.</div>
