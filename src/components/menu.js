 ...
 render(){
	return (
		<div>
			...
			to make or buy. And just buy dessert! You can start looking for recipes here: 
				<ul>
			...
			<div>If you’re throwing a cocktail party select four hors d’oevres to serve.</div>
				<ul>
